...
int main(){
    ...
    if (create != NULL){
        ...
        print_balise_html("div", "class='boutton'", "<a href='http://www.proud.com/cgi-bin/site.cgi?activer=1' >Activer</a>" , "div");

        print_balise_html("div", "class='boutton'", "<a href='http://www.proud.com/cgi-bin/site.cgi?desactiver=1' >Desactiver</a>", "div");
